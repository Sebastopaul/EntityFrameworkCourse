...
public class User : BaseEntity
{
    ...
    public ICollection<UserInEvent> SubscribedEvents { get; set; } = new Collection<UserInEvent>();
    public ICollection<UserInSession> SubscribedSessions { get; set; } = new Collection<UserInSession>();
    public ICollection<Rating> SessionRatings { get; set; } = new Collection<Rating>();
}